...
### project deploying
#cp ${G_NAME}/target/citizen.war /opt/tomcat/latest/webapps
echo -e "\n\nNOW: build new Docker image with this 'citizen.war' or copy it to running container in .../webapps/ and restart Tomcat by supervisorctl\n\n"
