...
### project deploying
echo -e "\n\nNOW: do only one thing of the followed ones:\n    - build new Docker image with this 'Geocit134/target/citizen.war'\n    - copy 'citizen.war' to running container in .../webapps/ and wait for deploying by Tomcat (20-30s)\n    - build Docker image from original Dockerfile\n\n"
